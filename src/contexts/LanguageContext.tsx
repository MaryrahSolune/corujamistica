...
const translationsData: Record<Locale, Record<TranslationKey, string>> = {
  'en': {
    ...
    specialPrizeNoticeDescription: 'Complete all 30 days to unlock an exclusive reward!',
  },
  'pt-BR': {
    mysticInsights: 'Coruja Mística',
    ...
    specialPrizeNoticeDescription: 'Complete os 30 dias para destravar uma recompensa exclusiva!',
  }
};
