...
export const availableIcons = [
  'UserCircle2', 'Gem', 'Sparkles', 'Moon', 'Sun', 'Star', 'Crown', 'Feather', 'Key', 'Scroll', 'Eye', 'BrainCircuit', 'Shield', 'Pyramid', 'Infinity', 'Hexagon', 'Flower', 'Flame', 'Leaf', 'Cat', 'Bird', 'Bot', 'Cloud', 'Dna', 'Fish', 'Ghost', 'Grape', 'Zap', 'Pentagon', 'Rainbow', 'Heart', 'Swords', 'ShieldCheck', 'Skull', 'YinYang', 'Waves', 'Mountain', 'Tornado', 'TreePalm', 'Aperture', 'Atom', 'Anchor', 'Axe', 'Balance', 'Castle', 'Church', 'Clover', 'Coffee', 'Comet', 'Diamond', 'Dice5', 'Droplet', 'FerrisWheel', 'Fingerprint', 'FlaskConical', 'Fox', 'Gamepad2', 'Guitar', 'Hammer', 'Headphones', 'Hourglass', 'Hut', 'IceCream2', 'Joystick', 'Lamp', 'Laptop', 'Lighthouse', 'Lock', 'Magnet', 'Map', 'Milestone', 'Mouse', 'Music', 'Paintbrush', 'Palette', 'PawPrint', 'PenTool', 'Pizza', 'Plane', 'Puzzle', 'Quote', 'Rocket', 'Sailboat', 'Scissors', 'Shell', 'Ship', 'Snail', 'Snowflake', 'Spade', 'Speaker', 'Telescope', 'Tent', 'Ticket', 'TowerControl', 'TrainTrack', 'Umbrella', 'Unicorn', 'Violin', 'Wallet', 'Watch', 'Wind', 'Wine', 'Wrench'
];
