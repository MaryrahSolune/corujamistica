...
export default function HomePage() {
 ...
 backgroundRepeat: 'no-repeat', // Add no-repeat
          ...
          <div className="container mx-auto px-4 relative z-10">
            <h1 className="text-5xl md:text-7xl font-bold font-serif mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary animate-fade-in [text-shadow:2px_2px_8px_rgba(0,0,0,0.7)]" style={{animationDelay: '0.2s'}}>
              {t('landingTitle')}
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in [text-shadow:2px_2px_5px_rgba(0,0,0,0.7)]" style={{animationDelay: '0.4s'}}>
              {t('landingSubtitle')}
            </p>
