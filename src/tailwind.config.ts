...
export default {
  ...
  theme: {
      ...
      colors: {
        ...
        'float-3': {
          '0%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '25%': { transform: 'translate(8px, -6px) rotate(0.4deg)' },
          '50%': { transform: 'translate(-4px, 12px) rotate(-0.5deg)' },
          '75%': { transform: 'translate(6px, 4px) rotate(-0.6deg)' },
          '100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
        },
        'float-up-and-fade': {
        ...
        'float-1': 'float-1 800s ease-in-out infinite',
        'float-2': 'float-2 900s ease-in-out infinite',
        'float-3': 'float-3 1000s ease-in-out infinite',
