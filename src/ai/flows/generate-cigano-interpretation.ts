...
A Foice (10) + O Peixe (34) = corte de dinheiro e de status.
...
A Torre (19) + A Montanha (21) = justiça demorada que geram problemas.
...
A Cruz (36) + A Chave (33) = necessidade de se aproximar da fé;
