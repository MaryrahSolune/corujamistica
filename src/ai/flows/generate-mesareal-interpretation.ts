...
3.  **FUNDA OS SIGNIFICADOS (LÓGICA CENTRAL E INEGOCIÁVEL):** Este é o passo mais importante. Você DEVE criar uma interpretação que combine a energia da **carta que caiu** com o contexto da **casa onde ela caiu**. A sua análise precisa ser um insight valioso que nasce da fusão desses dois significados, e não uma listagem separada.
    ...
    *   **Exemplo de Raciocínio OBRIGATÓRIO (Casa 23 + Carta Cegonha):** "Na **Casa 23 (Os Ratos - desgaste, perdas, estresse)**, a carta da **Cegonha** é uma bênção. Ela indica que as novidades que estão chegando vêm para resolver um problema de desgaste. Uma mudança positiva está a caminho para acabar com uma situação de estresse ou perda de energia."
