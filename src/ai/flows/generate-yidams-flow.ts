...
const generateYidamFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const mandalaPrompt = `Renderização em 8k de uma mandala de cura psicodélica e visionária, com precisão matemática e simetria fractal perfeita, inspirada na energia do Yidam ${chosenYidam.name} e na consulta do usuário: "${query.substring(0, 50)}...". A mandala deve conter: 1. Geometria sagrada extremamente complexa como a Flor da Vida ou o Cubo de Metatron, com linhas nítidas e perfeitas. 2. Símbolos sagrados relevantes (ex: vajra, lótus, roda do dharma) integrados de forma harmoniosa. 3. A essência de animais de poder como dragões, tigres ou garudas. 4. Flores exóticas e cristais luminescentes entrelaçados. 5. Cores vibrantes, iridescentes e translúcidas que pareçam de 5ª ou 7ª dimensão, com um brilho etéreo e uma sensação de paz e poder transcendental.`;
